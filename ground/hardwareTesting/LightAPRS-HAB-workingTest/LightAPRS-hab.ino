...
//****************************************************************************
// current callsign (josh t)
char  CallSign[7]="KQ4KNV"; //DO NOT FORGET TO CHANGE YOUR CALLSIGN
// callNumber -1 for testing purposes
int   CallNumber=-1; //SSID http://www.aprs.org/aprs11/SSIDs.txt
...
char comment[50] = "TEST kscucf.org TEST"; // Max 50 char
char StatusMessage[50] = "LightAPRS by TA9OHC & TA2MUN"; 
//*****************************************************************************

// time interval for TXs
unsigned int   BeaconWait=10; //TESTING APRS
